...
It is important to note the the assumptions upon which our approach currently
is based.  
Because no events are recorded by \YW\ while a script is executing, 
no dependencies between script inputs, intermediate data products, and file
outputs are directly observed. Instead, associations between input data, 
parameters, and intermediate and final data products
...
when such dependencies may be inferred,  using the fine-grained data dependency 
rules described in \cite{bowers2012rules}.
